...
class _CategorieDePrixDetailsState
  ...
  void initState() {
    ...
    Future.microtask(() {
      ref.read(tempSelectedIdsProvider.notifier).state = List.from(
        ref.read(categorieDePrixRiverpod).selected?.produitsIds ?? [],
      );
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return (drawerState is! UpdateProdsCategoriePrix)
        ? Scaffold(
          appBar: AppBar(
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              onPressed: () {
                                drawerNotifier.updateProdCategorieDePrix(
                                  model: model,
                                );
                              },
        ...
        : ProductSelectionScreen(
          ...
          onBack: () async {
            await categorieDePrixNotifier.update(
              model.copyWith(produitMode: mode, produitsIds: tempSelected),
            );
