                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ListTile(
                      ...
                      onTap: () async {
                        // Navigate to ProduitAttachement and wait for the selected products
                        final selectedProduits = await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder:
                                (context) => ProduitAttachement(
                                  selectedProduits:
                                      createModel.produitsIds ?? [],
                                ),
                          ),
                        );

                        // Update the createModel with the selected products
                        if (selectedProduits != null) {
                          final updated = createModel.copyWith(
                            produitsIds: selectedProduits,
                          );
                          context
                              .read<DrawerProvider>()
                              .openCreateCategorieDeModificateur(updated);
